...
(function($) {
    ...
    $.fn.lightBox = function(settings) {
        ...
        settings = jQuery.extend({
            ...
            imageLoading:			'/phil/protected/extentions/images/lightbox-ico-loading.gif',		// (string) Path and the name of the loading icon
            ...
            imageBtnClose:			'/phil/protected/extentions/images/lightbox-btn-close.gif',		// (string) Path and the name of the close btn
