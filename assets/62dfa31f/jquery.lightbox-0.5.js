...
(function($) {
    ...
    $.fn.lightBox = function(settings) {
        ...
        settings = jQuery.extend({
            ...
            imageLoading:			'/phil/protected/extensions/images/lightbox-ico-loading.gif',		// (string) Path and the name of the loading icon
            imageBtnPrev:			'/phil//protected/extentions/images/lightbox-btn-prev.gif',			// (string) Path and the name of the prev button image
            imageBtnNext:			'/phil//protected/extentions/images/lightbox-btn-next.gif',			// (string) Path and the name of the next button image
            ...
            imageBlank:				'/phil//protected/extentions/images/lightbox-blank.gif',			// (string) Path and the name of a blank image (one pixel)
