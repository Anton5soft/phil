...
(function($) {
    ...
    $.fn.lightBox = function(settings) {
        ...
        settings = jQuery.extend({
            ...
            imageLoading:			'/protected/extentions/images/lightbox-ico-loading.gif',		// (string) Path and the name of the loading icon
            imageBtnPrev:			'/protected/extentions/images/lightbox-btn-prev.gif',			// (string) Path and the name of the prev button image
            imageBtnNext:			'/protected/extentions/images/lightbox-btn-next.gif',			// (string) Path and the name of the next button image
            imageBtnClose:			'/protected/extentions/images/lightbox-btn-close.gif',		// (string) Path and the name of the close btn
            imageBlank:				'/protected/extentions/images/lightbox-blank.gif',			// (string) Path and the name of a blank image (one pixel)
