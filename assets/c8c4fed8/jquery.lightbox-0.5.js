...
(function($) {
    ...
    $.fn.lightBox = function(settings) {
        ...
        settings = jQuery.extend({
            ...
            imageLoading:			'protected/extensions/SliderPopImage/assets/images/lightbox-ico-loading.gif',		// (string) Path and the name of the loading icon
            imageBtnPrev:			'protected/extensions/SliderPopImage/assets/images/lightbox-btn-prev.gif',			// (string) Path and the name of the prev button image
            imageBtnNext:			'protected/extensions/SliderPopImage/assets/images/lightbox-btn-next.gif',			// (string) Path and the name of the next button image
            imageBtnClose:			'protected/extensions/SliderPopImage/assets/images/lightbox-btn-close.gif',		// (string) Path and the name of the close btn
            imageBlank:				'protected/extensions/SliderPopImage/assets/images/lightbox-blank.gif',			// (string) Path and the name of a blank image (one pixel)
