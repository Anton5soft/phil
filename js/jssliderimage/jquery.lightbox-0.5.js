...
(function($) {
    ...
    $.fn.lightBox = function(settings) {
        ...
        settings = jQuery.extend({
            ...
            imageLoading:			'./js/jssliderimage/images/lightbox-ico-loading.gif',		// (string) Path and the name of the loading icon
            imageBtnPrev:			'./js/jssliderimage/images/lightbox-btn-prev.gif',			// (string) Path and the name of the prev button image
            imageBtnNext:			'./js/jssliderimage/images/lightbox-btn-next.gif',			// (string) Path and the name of the next button image
            imageBtnClose:			'./js/jssliderimage/images/lightbox-btn-close.gif',		// (string) Path and the name of the close btn
            imageBlank:				'./js/jssliderimage/images/lightbox-blank.gif',			// (string) Path and the name of a blank image (one pixel)
